...
> При локальной сборке через npm i, если падает, использовать npm i force (проблема с необновленными peerDependencies для react-virtualized, в будущем обновить пакет, когда его поправят)
---
